...
> Answer: 
ACF: Whether or not the data are autoregressive
PACF: The order of the model (number of terms) is determined by the number of significant lags in PACF. 

* MA(1)

> Answer:
ACF: gives the order of the model
PACF: tells you if the data are autoregressive based on exponential decay in lags.
