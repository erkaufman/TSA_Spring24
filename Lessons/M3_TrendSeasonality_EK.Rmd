...
dummies= seasonaldummy(y_detrend) #seasonal dummy must use a ts object

#linear model where y_detrend is the y dependent upon dummies 

#i results, the intercept term is december, if you want dummiesdec, then you must run the linear model without the intercept term
