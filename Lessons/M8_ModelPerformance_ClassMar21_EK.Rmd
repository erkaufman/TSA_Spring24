...
#Model 1: Arithmetic mean
MEAN_scores <- accuracy(MEAN_seas$mean,observed)  #store the performance metrics (comparing the forecast from the model with the observed )
