...
#see seasonality, and that there is missing data in the middle of our timeseries dataset
```
...
clean_wind_data <- tsclean(ts_wind_data)  #object should be a time series (replacing missing data AND outliers)
...
How to take care of NAs without removing outliers in tsclean! 
`forecast::na.interp()` 
`zoo::na.approx()`
